...
<body>
  ...
  <main>
        ...
        <div style="overflow-x:auto;">
          <table style="width:100%;border-collapse:collapse;font-size:12px;">
            ...
            <tbody id="oscParamsTable">
              ...
              <tr>
                <td style="padding:6px 10px;color:#58a6ff;font-family:monospace;">/factory-reset</td>
                <td style="padding:6px 10px;color:#3fb950;">i / T</td>
                <td style="padding:6px 10px;color:#c9d1d9;">1 / True</td>
                <td style="padding:6px 10px;color:#8b949e;" data-i18n="osc_desc_factory">Efface la config NVS et redémarre (reset usine)</td>
              </tr>
            </tbody>
          </table>
        </div>
    ...
    <div id="tab-network" class="tab-content">
      <div class="card">
        <h2>🌐 <span data-i18n="eth_title">Ethernet OSC</span></h2>
