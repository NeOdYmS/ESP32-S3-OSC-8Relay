    ...
    <div id="tab-system" class="tab-content">
      ...
      <div class="card">
        ...
        <div class="info-box" style="margin-bottom:10px;">
          Source: <a href="https://github.com/NeOdYmS/ESP32-S3-OSC-8Relay/blob/main/CHANGELOG.md" target="_blank" rel="noopener noreferrer" style="color:#58a6ff;">CHANGELOG.md</a>
        </div>
        <pre style="background: #0d1117; padding: 12px; border-radius: 6px; font-size: 12px; overflow: auto; max-height: 300px;">
v1.2.4 - Avril 2026
- Interface multilingue avec selecteur de langue discret en haut a droite
- Traduction UI en 5 langues principales (FR/EN/ES/DE/ZH)
- Endpoint /api/live combine pour relays + systeme + log OSC
- Polling chaine optimise (~30ms) pour garder la priorite OSC
- Log ameliore: auto-scroll, clear, redimensionnement, buffer 200 lignes
- RAM: alerte uniquement en critique + indicateur dans infos systeme
